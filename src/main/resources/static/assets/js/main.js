...
!(function (g) {
    ...
    $(window).on("scroll", function () {
        ...
        //         '<li><a href="product-left-sidebar.html" class="sidtco_pro_img"><img src="' +
        //         b +
